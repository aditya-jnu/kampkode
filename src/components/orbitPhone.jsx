  ...
  return (
    ...
    <div className="relative flex h-screen w-full items-center justify-center overflow-hidden rounded-lg border bg-background md:shadow-xl">
        <div className="flex flex-col gap-8 items-center justify-center">
             <div className="font-bold text-4xl flex justify-center w-screen">
                <p className="text-center">We've really speed up our workflow</p> 
             </div>
      ...
      <OrbitingCircles
        className="h-[80px] w-[80px] bg-transparent border-none"
        duration={20}
        delay={10}
        radius={80}
      >
      ...
      <OrbitingCircles
        className="h-[30px] w-[30px] bg-transparent border-none"
        duration={20}
        delay={50}
        radius={420}
      >
